...
main_picwidth: "80%"
logoleft_name: '![](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/Attendance/Salem_20220405/images/qr_code_small.svg){.main-img-left}'
...
```{r event_study_plot_all, fig.height=5.5, fig.width=9, fig.align='center', dev='svg', echo=FALSE, warning=FALSE, message=FALSE}
library(ggplot2)
library(tidyverse)
library(hrbrthemes)
library(firasans)
