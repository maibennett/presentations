...
- **.coolblue[Non-representative patterns of attendance.]**
  ...
  - Prior work: Re-classification of low-performers .small[(e.g. Figlio & Loeb, 2011; Figlio & Getzler, 2007; Cullen & Reback, 2006)]; Use of disciplinary measures .small[(Figlio, 2006)]; Distortions in quality signals .small[(Cuesta et al., 2020)]
...
kableExtra::kable(tab4th, align = "lcccc", caption = "Results for 4th Grade",
             col.names = c('GPA Decile', 'Told', 'Notification', 'Preparation', 'Grades'), format = "html") %>% kable_paper(full_width = FALSE)
