...
.left[.small[Valle Nevado Workshop on Economics of Education<br>Universidad de los Andes<br>August 17th, 2023]]]
...
- Prior literature related to student exclusion:
  ...
  - Reclassification of low-performers as students with disabilities .small[(Figlio & Loeb, 2011)]
...
#                   yend = impute$mean[impute$cluster==2 & impute$imputation=="Impute Pred-Obs (Decile)"]), color = "grey") +
  ...
  scale_color_manual(name = "Cluster", labels = c("Increase Att (Mean)","Lower att (Mean)"),values = c(cols[2],cols[3])) +
  scale_fill_manual(name = "Cluster", labels = c("Increase Att (Mean)","Lower att (Mean)"),values = c(alpha(cols[2],0.8),alpha(cols[3],0.8))) +
