...
.left[.small[IROM Brown Bag<br>August 8th, 2023]]]
...
- $D^{PT}_{ipsgt}$: Indicator variable $\mathrm{I(p = P, t = T, g = G^*)}$, where $G^*$ is the tested grade.
...
PCA_clus$cluster <- factor(PCA_clus$cluster, levels = c(1,2), labels=c("Similar","Lower Att"))
...
.left[.small[IROM Brown Bag<br>March 29th, 2023]]]
