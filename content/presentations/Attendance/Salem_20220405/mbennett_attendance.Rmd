...
kableExtra::kable(tab4th, align = "lcccc", caption = "Results for 4th Grade",
  ...
  kable_paper(bootstrap_options = c("hover","condensed"), full_width = FALSE, stripe_color="ltgray")
```
...
df_wide_test <- read.csv("https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/Attendance/Salem_20220405/data/d_tab.csv")

datasummary_balance(~ cluster, data = d_tab, dinm_statistic = "p.value", fmt = "%.2f", stars = TRUE,
