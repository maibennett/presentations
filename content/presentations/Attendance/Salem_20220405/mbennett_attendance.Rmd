...
style_mono_accent(
  ...
  extra_css = list(
   ...
   # ".remark-slide table thead th" = list(),
    ...
    ".box-2,.box-2a,.box-2b,.section-title-2" = list("background-color" = "#974DB5"),
    ...
    ".box-1,.box-1a,.box-1s,.box-1b,.box-1l,.box-1LA,.section-title-1" = list("background-color" = "#5A3D66",
                                                                              "border-radius" = "15px"),
    ".box-2,.box-2a,.box-2s,.box-2b,.box-2l,.box-2LA,.section-title-2" = list("background-color" = "#974DB5",
                                                                              "border-radius" = "15px"),
   ...
   ".box-7LA, .box-6LA, .box-5LA, .box-4LA, .box-3LA, .box-2LA, .box-1LA" = list("color" = "#FFFFFF",
    ...
    ".box-2trans,.box-2transl,.box-2Trans" = list("border"="5px solid #974DB5"),
...
<br>
<br>
.white[**.small[.small[Causal Inference Seminar, Salem Center<br>April 5th, 2022]]**]
...
.center[
![:scale 80%](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/Attendance/Salem_20220405/images/test_scandal1.png)
]
...
.center[
![:scale 80%](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/Attendance/Salem_20220405/images/test_discrimination.png)
]

---
# Motivation

- Beyond explicit cheating --> Students' exclusion

  - Cite literature

- Schools have incentives to try to game the system
...
- Machine learning prediction:
  ...
  - Identification of gaming schools
...
cols <- c("#5A3D66","#974DB5","#4493AE","#A5AC20","#DAE058")
