...
$$Y_{ipsgt} = \sum_{p=1}^5\sum_{t=-4}^5 \tau_{pt}\mathrm{I}(g=G^{*}) + \gamma_{pt} + \alpha_i + \epsilon_{ipsgt}$$
...
datasummary_balance(~ cluster, data = d_tab, dinm_statistic = "p.value", fmt = "%.2f", stars = TRUE, align = c("lcccccc"),
                    output = "html",
