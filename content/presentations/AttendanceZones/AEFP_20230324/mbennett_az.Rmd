...
- Schools can either **.col6[attract]** or **.col6[push away]** residents depending on socioeconomic characteristics .small[(Hasan & Kumar, 2019; Gibbons, Machin, & Silva 2013; Figlio & Lucas, 2004)]

--
<br>
<br>

- Neighborhoods have important effects on **.col6[long-term outcomes]** .small[(Chetty et al. 2020)]

--
<br>
<br>

- Racial and socioeconomic disparities in the school system also have long-term effects on students .small[(Reardon, 2016; Billings et al., 2014)]

--

.box-7Trans[New public schools opening <br>
&darr;<br>
...
- How do **.col6[changes in attendance zones (AZ)]** affect:
...
- **.col6[New high schools]** in Texas that changed AZ

--
<br>
<br>

- **.col6[Outcomes of interest]**:
...
- **.col6[Common Core Data (CCD) [2005-2019]]**: Administrative data from NCES, including demographic and socioeconomic characteristics of schools.

--
<br>

- **.col6[Texas Educacion Agency (TEA) data [2005-2019]]**: Performance data for schools over time.

--
<br>

- **.col6[Attendance zones maps [2009-2017]]**: Geographic data for school boundaries over time from SABS, SABINS, and Maponics.

--
<br>

- **.col6[Census and American Community Survey (ACS) data [2010-2019]]**: Demographic information at the census tract level

--
<br>

- **.col6[Housing Prices data [2005-2019]]**: Information about housing prices over time from CoreLogic and Zillow *(coming soon)*.

---
# Identification Strategy: An Augmented Synthetic Control Method

- Use a **.col6[weighted average]** of similar districts/schools/AZ/neighborhoods to create a comparison group for affected areas.

--

- Under **.col6[Augmented Synthetic Control Method]** (ASCM) (Ben-Michael et al., 2020) there is a correction for poor fit:

$$\hat{Y}^{aug}_{1T}(0) = \sum_{W_i=0}\gamma_iY_{iT}+\color{#820a94}{(\hat{m}_{iT}(\mathbf{X_i})-\sum_{W_i=0}\gamma_i\hat{m}_{iT}(\mathbf{X_i}))}$$
.small[
...
- Proposal of **.col6[sensitivity analysis to hidden bias]**:
...
.center[
![:scale 40%](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/AttendanceZones/AEFP_20230324/images/map0_districts.png)]
...
- Identify **.col6[6 new high schools]** between 2012-2016 that change AZ.
...
- **.col6[Demographics]**: Decreasing trend in white students enrollment (left) vs increasing trend in African American enrollment (right).
...
- **.col6[Performance]**: Decreasing trend % of proficiency (sharper for African American students).
...
- Attendance zones have a huge role in **.col6[shaping neighborhoods]** and nearby areas.

--
<br>
<br>

- Importance of understanding the effects of **.col6[new schools]** and their location and boundaries.
