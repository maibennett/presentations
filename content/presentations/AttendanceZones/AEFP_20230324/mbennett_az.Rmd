...
style_mono_accent(
  ...
  extra_css = list(
   ...
   ".box-7LA, .box-6LA, .box-5LA, .box-4LA, .box-3LA, .box-2LA, .box-1LA" = list("color" = "#FFFFFF",
    ...
    ".box-6trans,.box-6transl,.box-6Trans" = list("border"="5px solid #F89441"),
...
- **.darkorange[Context]**: New public schools opening $\rightarrow$ Changes in attendance zones


---
# Research question

.box-3tL[How do changes in attendance zones affect:]
   
--
<br>

.box-4trans[Zoned-in areas (i.e. neighborhoods)?]

--
<br>

.box-6trans[Zoned-out areas (i.e. neighborhoods and existing schools?)]

---
# What do we mean by zoned-in areas?

.pull-left[
- **Zoned-in area**: Area for a new school *S'* attendance zone.
]

.center[
![:scale 50%](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/AttendanceZones/AEFP_20230324/images/map1.png)]


---
# What do we mean by zoned-out area?

.pull-left[
- **Zoned-out area**: New attendance zone for school *S* after the opening of schools *S'*.

- **Spillover school**: School which had a part of their catchment area zoned-out.
]

.center[
![:scale 50%](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/AttendanceZones/AEFP_20230324/images/map2.png)]
...
- **Housing Prices data [2005-2019]**: Information about housing prices over time from CoreLogic *(coming soon)*.
---
# Identification Strategy: An Augmented Synthetic Control Method

- Use similar districts/schools/attendance zones/neighborhoods to create a comparison group for affected areas.

[INSERT EXPLANATION OF ASCM]

- Focus specifically in high schools in Texas: New schools 2012-2016 *that affected AZ*.

--

- Proposal of sensitivity analysis to hidden bias:
...
.center[
![:scale 50%](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/AttendanceZones/AEFP_20230324/images/map0_districts.png)]

---
# Zoned-in Areas: How do neighborhoods change?

- Do new schools usually increase gentrification?

---
# Zoned-out Areas: How are schools affected?

- What happens when a new school takes part of an existing school's students?
...
- Importance of understanding the effects of new schools.
