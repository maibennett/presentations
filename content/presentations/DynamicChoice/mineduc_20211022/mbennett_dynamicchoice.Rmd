...
**.darkorange[Población Objetivo]**: 80,419 estudiantes que rindieron la PDT 2021 pero no se matricularon (35.44%)

  [Tabla con diferencias: puntaje, año egreso, madre con estudios de ed superior, tecnico profesional]
  
---
# Datos: Postulaciones

.left[
![:scale 60%](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/DynamicChoice/mineduc_20211022/images/AreasPostulacion.png)
]
...
- **.darkorange[Tasa de respuesta]**: 11,178 encuestas iniciadas ($\approx$ 14%) y 5,312 completas.

- **.darkorange[Módulos]**:

  - Razones para no matricularse
  - Financiamiento, beneficios, y FUAS
  - Preparación PDT 2020 y efectos pandemia
  - Planes 2021
...
.center[
![](https://raw.githubusercontent.com/maibennett/presentations/main/content/presentations/DynamicChoice/mineduc_20211022/images/BrechaPuntajeApp_01Razon.png)
]
...
.pull-left[
- **.darkorange[65% financiaria estudios con gratuidad]**
