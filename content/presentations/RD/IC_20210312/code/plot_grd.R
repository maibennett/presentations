...
# Load real data to get some parameters
dir_data = "C:/Users/mc72574/Dropbox/PhD Columbia/Research/DD Gratuidad/New_Analysis"

#source("C:/Users/maibe/Dropbox/PhD Columbia/Research/textme_func.R")
...
legend("topleft",legend = c("Data","Grid","Cutoff"),ncol=1,
       lty=c(NA,2,2),pch=c("o",NA,NA),lwd=c(NA,1,2),col=c("darkgrey","black","black"),cex=0.8)
