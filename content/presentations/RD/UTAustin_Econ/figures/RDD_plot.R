...
save(df_pre,df_post, file=paste0(dir_data,"/data_plot.Rdata"))
...
ggplot(df_pre,aes(y=Y,x=xaxisTime, label=NA), fill="light grey")+geom_point(fill="light grey", color="light grey")+
  ...
  geom_point(aes(y=10.5,x=2.5),
             color="black", fill="gold2", shape=24, size=3)+
  #Average
  geom_segment(aes(x = 9.5, y = 3.07, xend = 10, yend = 3.07), col="blue", size=1) +
  geom_segment(aes(x = 10, y = 3.1, xend = 10.5, yend = 3.1), col="blue", size=1) +
  geom_segment(aes(x = 10, y = 3.07, xend = 10, yend = 3.1), col="red", size=1) +
...
ggplot(df_pre,aes(y=Y,x=xaxisTime, label=NA), fill="light grey")+geom_point(fill="light grey", color="light grey")+
  ...
  geom_point(aes(y=10.5,x=2.5),
             color="black", fill="turquoise3", shape=21, size=3)+
  #Average
  geom_segment(aes(x = 9, y = 3.35, xend = 10, yend = 3.35), col="blue", size=1) +
  geom_segment(aes(x = 10, y = 3.4, xend = 11, yend = 3.4), col="blue", size=1) +
  geom_segment(aes(x = 10, y = 3.35, xend = 10, yend = 3.4), col="red", size=1) +
...
ggplot(df_pre,aes(y=Y,x=xaxisTime, label=NA), fill="light grey")+geom_point(fill="light grey", color="light grey")+
  ...
  #Average
  geom_segment(aes(x = 8.5, y = 3.2, xend = 10, yend = 3.2), col="blue", size=1) +
  geom_segment(aes(x = 10, y = 3.6, xend = 11.5, yend = 3.6), col="blue", size=1) +
  geom_segment(aes(x = 10, y = 3.2, xend = 10, yend = 3.6), col="red", size=1) +
...
ggplot(df_pre,aes(y=Y,x=xaxisTime, label=NA), fill="light grey")+geom_point(fill="light grey", color="light grey")+
  ...
  annotate("rect", xmin = 9.1, xmax = 10.9, ymin = 10.6, ymax = 11.4,
           color="white", fill="white") +
  annotate("text", x = 10, y = 11, label = "BW*", hjust=0.5, size=5, col="black", fontface=2)+
  geom_segment(aes(x = 9.4, y = 11, xend = 8, yend = 11), col="black", size=0.7,
               arrow = arrow(length=unit(0.2,"cm"), ends="last", type = "open"))+
  geom_segment(aes(x = 10.6, y = 11, xend = 12, yend = 11), col="black", size=0.7,
               arrow = arrow(length=unit(0.2,"cm"), ends="last", type = "open"))+
...
ggplot(df_post,aes(y=Y,x=xaxisTime, label=NA), fill="light grey")+geom_point(fill="light grey", color="light grey")+
  ...
  #Average
  geom_segment(aes(x = 9, y = 3.85, xend = 10, yend = 3.85), col="blue", size=1) +
  geom_segment(aes(x = 10, y = 6.07, xend = 11, yend = 6.07), col="blue", size=1) +
  geom_segment(aes(x = 10, y = 3.85, xend = 10, yend = 6.07), col="red", size=1) +
...
ggplot(df_post,aes(y=Y,x=xaxisTime, label=NA), fill="light grey")+geom_point(fill="light grey", color="light grey")+
  ...
  geom_point(aes(y=6.07,x=11),
             color="black", fill="black", size=3)+
  annotate("text", x = 8.5, y = 5, label = "TATE", hjust=0, size=5, col="red", fontface=2)
