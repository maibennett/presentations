...
url_data = "https://github.com/maibennett/sds_did/blob/main/sim_resultsv3_match4_caliper0_nsim100.Rdata?raw=true"
load(url(url_data))
...
d = data.frame(cbind(c(s1,s2,s3,s4,s5,s5alt,s6),rep(c("Simple","CA","TVA","Match (level)",
                     ...
                     c(rep("S1: Time-invariant_cov effect",8),
                       ...
                       rep("S6: Evolution diff._by group (adj)",8),
                       rep("S7: Evolution diff._in post",8)),
