...
style_mono_accent(
  ...
  extra_css = list(
    ...
    ".source" = list("color" = "#8c8c8c",
                     "font-size" = "80%"),
    "table tr#highlight" = list("background-color" = "#eee1f0",
                                  "color" = "#900DA4"),
...
**Match on pre-treat cov (MIP)**         | **`lm(y ~ a*p + t, data=cov.match.mip)`**
**Match on all cov (MIP)**               | **`lm(y ~ a*p + t, data=cov.match.mip.all)`** 
]
